...
// let publicId = '';
// const audioId = '';
songFinderRouter.get('/', function (req, res) {
    var _a = req.query, artistName = _a.artistName, song = _a.song;
    axios_1["default"].get("https://api.lyrics.ovh/v1/".concat(artistName, "/").concat(song))
        .then(function (data) {
